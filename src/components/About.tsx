        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-muted-foreground mb-6 leading-relaxed">
              ...
              with the highest quality soil products that promote sustainable agriculture. We believe
              that healthy soil is the foundation of a healthy planet.
            </p>
            
            <p className="text-muted-foreground mb-8 leading-relaxed">
              Our team of soil scientists and agricultural experts work tirelessly to develop products
              that not only enhance plant growth but also improve soil health for generations to come.
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              <div className="p-5 bg-secondary/50 rounded-xl">
                ...
                <p className="text-sm text-muted-foreground">
                  To empower every farmer with premium, organic soil solutions that maximize yield
              ...
              <div className="p-5 bg-accent/50 rounded-xl">
                ...
                <p className="text-sm text-muted-foreground">
                  A world where sustainable farming practices are the norm, and healthy soil nurtures
